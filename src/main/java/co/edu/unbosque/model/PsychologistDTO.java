...
public class PsychologistDTO extends PersonDTO {
	 ...
	 * @param salary           :Psychologist salary
	 */
	public PsychologistDTO(String userName, String password, String name, long document, LocalDate dateOfBirth,
			String cityOfBirth, Year yearOfGraduation, int daysInService, int suportedSessions, double salary) {
