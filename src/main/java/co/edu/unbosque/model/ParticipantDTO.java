...
public class ParticipantDTO extends PersonDTO{
	 ...
	 */
	public ParticipantDTO(String userName,String password,String name, long document, Date dateOfBirth, String cityOfBirth, int participatedSessions, String nickName) {
	 ...
	 * @param cityOfBirth :City of birth of participant
	 */
	public ParticipantDTO(String userName,String password,String name, long document, Date dateOfBirth, String cityOfBirth) {
		super(userName,password,name, document, dateOfBirth, cityOfBirth);
	}
