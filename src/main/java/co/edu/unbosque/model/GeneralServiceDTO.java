...
public class GeneralServiceDTO extends PersonDTO{
	 ...
	 */
	public GeneralServiceDTO(String userName,String password,String name, long document, Date dateOfBirth, String cityOfBirth, double salary, int sessionsCleaned) {
	 ...
	 * @param cityOfBirth :City of birth of the general services person
	 */
	public GeneralServiceDTO(String userName,String password,String name, long document, Date dateOfBirth, String cityOfBirth) {
		super(userName, password,name, document, dateOfBirth, cityOfBirth);
	}
