...
import co.edu.unbosque.model.persistence.GeneralServiceDAOTest;
import co.edu.unbosque.model.persistence.ParticipantDAO;
import co.edu.unbosque.model.persistence.ParticipantDAOTest;
import co.edu.unbosque.model.persistence.PsychologistDAO;
import co.edu.unbosque.model.persistence.PsychologistDAOTest;
...
public class UserControllerServletTest extends HttpServlet {
	 ...
	 */
	public UserControllerServletTest() {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (method.equals("login")) {
			...
			sdao.create(
					new PsychologistDTO(username, password, name, Long.parseLong(document), birth, city,
