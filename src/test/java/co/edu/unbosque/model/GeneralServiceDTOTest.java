 ...
 */
public class GeneralServiceDTOTest extends PersonDTOTest {
	...
	public void constructorWithHerencyGeneralServiceSuccessful() {
		...
		String nickname2 = "test123";
		String password2 = "test123";
		String name2 = "New Test";
		long document2 = 0000000000;
		Date date2 = new Date(01, 01, 2000);
		String city2 = "Pacho";
		double salary2 = 1000000;
		int sessions2 = 6;
