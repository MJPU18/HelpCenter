 ...
 */
public class PsychologistDTOTest extends PersonDTO{
	 ...
	 */
	public PsychologistDTOTest(Year yearOfGraduation, int daysInService, int suportedSessions, double salary) {
		super();
	 ...
	 * @param salary :Psychologist salary
	 */
	public PsychologistDTOTest(String userName,String password,String name, long document, Date dateOfBirth, String cityOfBirth, Year yearOfGraduation, int daysInService, int suportedSessions, double salary) {
	 ...
	 * @param cityOfBirth :City of birth of the psychologist
	 */
	public PsychologistDTOTest(String userName, String password, String name, long document, Date dateOfBirth,String cityOfBirth) {
		super(userName, password, name, document, dateOfBirth, cityOfBirth);
	}
